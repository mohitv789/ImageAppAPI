...
from .views import ImageViewSet,AlbumViewSet, UserLoginView,UserRegistrationView,UserProfileView, ImagePostViewSet, ProfileFeed
...
urlpatterns = [
    ...
    path('api/signup/', UserRegistrationView,name="signup"),
